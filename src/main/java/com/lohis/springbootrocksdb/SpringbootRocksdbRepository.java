package com.lohis.springbootrocksdb;
...
@Slf4j
@Repository
public class SpringbootRocksdbRepository implements KVRepository<String, Object> {
//    private static final Logger log = Logger.getLogger( SpringbootRocksdbRepository.class.getName() );
